                ...
                <div class="d-md-flex row m-0 quick-action-btns" role="group"aria-label="buttons">
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn bg-white text-success px-0">
                            <h5>
                                <i class="fa fa-user" aria-hidden="true"></i> Add Petugas
                            </h5>
                        </button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn bg-white text-success px-0">
                            <h5>
                            <i class="fa fa-server" aria-hidden="true"></i> Add Proyek
                            </h5>
                        </button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn bg-white text-success px-0">
                            <h5>
                            <i class="fa fa-users" aria-hidden="true"></i> Add Pelanggan
                            <h5>
                        </button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                        <button type="button" class="btn bg-white text-success px-0">
                            <h5>
                            <i class="fa fa-file-text" aria-hidden="true"></i>  Print Laporan
                            </h5>
                        </button>
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h4 class="text-left text-success mb-4"><strong>Berikut ini adalah tata cara untuk menanggapi keluhan :</strong></h4>
                            <div class="text-dark mb-4">
                                <ol>
                                <li class="text-left me-4">Pastikan keluhan didukung dengan dokumentasi keluhan</li>
                                <li class="text-left my-2">Tanggapi keluhan dengan mengubah status Proses dan memberikan tanggapan</li>
